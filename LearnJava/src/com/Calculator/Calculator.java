...
public class Calculator {
    ...
    private void initialize() {
        ...
        textField.setBounds(5, 5, 358, 82);
        frame.getContentPane().add(textField);
        textField.setColumns(10);

        ButtonGroup btg=new ButtonGroup();
        JRadioButton radioButtonOn = new JRadioButton("On");
        radioButtonOn.setFont(new Font("Ariel", Font.BOLD, 17));
        radioButtonOn.setBounds(12, 108, 74, 32);
        frame.getContentPane().add(radioButtonOn);

        JRadioButton radioButtonOff = new JRadioButton("Off");
        radioButtonOff.setFont(new Font("Ariel", Font.BOLD, 17));
        radioButtonOff.setBounds(12, 145, 74, 32);
        frame.getContentPane().add(radioButtonOff);

        /**both RadioButtons are added in ButtonGroup to select one button at a time*/
        btg.add(radioButtonOn);
        btg.add(radioButtonOff);
        ...
        backSpace.setFont(new Font("Ariel", Font.BOLD, 22));
        backSpace.setForeground(new Color(0, 0, 0));
        backSpace.setBounds(94, 108, 72, 69);
        frame.getContentPane().add(backSpace);

        JButton bc = new JButton("C");
        bc.setFont(new Font("Ariel", Font.BOLD, 22));
        ...
        bPlus.setFont(new Font("Ariel", Font.BOLD, 22));
        ...
        b7.setFont(new Font("Ariel", Font.BOLD, 22));
        ...
        b8.setFont(new Font("Ariel", Font.BOLD, 22));
        ...
        b9.setFont(new Font("Ariel", Font.BOLD, 22));
        ...
        bMin.setFont(new Font("Ariel", Font.BOLD, 22));
        ...
        b4.setFont(new Font("Ariel", Font.BOLD, 22));
        ...
        b5.setFont(new Font("Ariel", Font.BOLD, 22));
        ...
        b6.setFont(new Font("Ariel", Font.BOLD, 22));
        ...
        bx.setFont(new Font("Ariel", Font.BOLD, 22));
        ...
        b1.setFont(new Font("Ariel", Font.BOLD, 22));
        ...
        b2.setFont(new Font("Ariel", Font.BOLD, 22));
        ...
        b3.setFont(new Font("Ariel", Font.BOLD, 22));
        ...
        bd.setFont(new Font("Ariel", Font.BOLD, 22));
        ...
        b0.setFont(new Font("Ariel", Font.BOLD, 22));
        ...
        bp.setFont(new Font("Ariel", Font.BOLD, 28));
        ...
        btnNewButton.setFont(new Font("Ariel", Font.BOLD, 28));
        ...
        bEqual.setFont(new Font("Ariel", Font.BOLD, 28));
        ...
        bEqual.setBounds(236, 454, 124, 75);
